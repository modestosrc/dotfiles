...
export OSH='/home/mateus/.oh-my-bash'
...
test -r /home/mateus/.opam/opam-init/init.sh && . /home/mateus/.opam/opam-init/init.sh > /dev/null 2> /dev/null || true
# source ~/.bash_profile
...
PATH="/home/mateus/perl5/bin${PATH:+:${PATH}}"; export PATH;
PERL5LIB="/home/mateus/perl5/lib/perl5${PERL5LIB:+:${PERL5LIB}}"; export PERL5LIB;
